...
export default function ForTeachers() {
  ...
  return (
    <section className="py-20 bg-gradient-to-b from-gray-50 via-white to-gray-100 relative overflow-hidden">
      {/* Background blobs */}
      <div className="absolute top-0 left-1/4 w-72 h-72 bg-indigo-200 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-pulse"></div>
      <div className="absolute bottom-0 right-1/4 w-72 h-72 bg-pink-200 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-pulse"></div>
      ...
      <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center gap-10 relative z-10">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h2 className="text-3xl font-bold mb-4 text-indigo-700">For Teachers</h2>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h3 className="text-lg font-semibold text-gray-700 mb-4 text-center">Student Struggle Insights</h3>
          <div className="h-72">
